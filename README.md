...
Issue #18 version-aware default apps / Start menu restore intake and report-only acceptance scaffold 见 [User Experience Restore Intake](docs/58-issue18-user-experience-restore-intake.md) 和 [User Experience Restore Acceptance](docs/59-issue18-user-experience-restore-acceptance.md)；capability matrix、template metadata、scope semantics 和 verification plan 见 [User Experience Capability Matrix](docs/60-issue18-user-experience-capability-matrix.md)，当前仍为 report-only。
