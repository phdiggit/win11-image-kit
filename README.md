...
28. Issue #14 质量门禁 runner/report、验收与收口准备见 [Acceptance](docs/41-issue14-quality-gates-acceptance.md)、[Close Preparation](docs/42-issue14-close-preparation.md)、[Main Validation Evidence](docs/43-issue14-main-validation-evidence.md)
