Describe "Script governance final audit stop-line" {
    ...
    It "documents lifecycle rules for validators and Pester tests" {
        ...
        Assert-KitMatch $script:Doc "No duplicate or obsolete public validator entrypoint is identified for deletion"
        ...
        Assert-KitMatch $script:Doc "No obvious duplicate Pester file is safe to delete"
    }
