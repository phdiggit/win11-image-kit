...
本目录根层只保留中文主文档、关键当前入口、Codex 工作流/模板和本索引。英文阶段文档、完成态证据、治理记录和 Future True UX Restore 历史材料统一放入 `docs/archive/`。

## 根目录入口

- 项目总览和路线图入口：[`../README.md`](../README.md)
- Codex 工作流和 PR 生命周期：[`codex-workflow.md`](codex-workflow.md)
- 任务卡模板：[`codex-task-card-template.md`](codex-task-card-template.md)
- WinPE 捕获与还原：[`03-WinPE捕获与还原.md`](03-WinPE捕获与还原.md)
- 结果模型与报告验收：[`08-结果模型与报告验收.md`](08-结果模型与报告验收.md)
- Issue #6 关闭和 main 证据入口：[`09-issue6-最终验收清单.md`](09-issue6-最终验收清单.md)、[`10-issue6-关闭准备与FullValidate证据.md`](10-issue6-关闭准备与FullValidate证据.md)
...
Future True UX Restore 的后续规划从以下归档治理入口开始：
