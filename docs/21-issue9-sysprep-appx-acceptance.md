...
- Confirm `docs/20-issue9-sysprep-appx-gate.md` describes the audit-only gate and manual repair boundary.
...
- Confirm `docs/23-issue9-main-validation-evidence.md` is updated only after real main/workflow evidence exists.
