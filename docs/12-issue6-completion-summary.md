...
- [docs/11-issue6-main-validation-evidence.md](11-issue6-main-validation-evidence.md)
...
`docs/11-issue6-main-validation-evidence.md` remains the authoritative main Full Validate evidence record.
