...
The docs governance implementation moved English stage documents out of root `docs/` into `docs/archive/`. Completed roadmap documents live under `docs/archive/completed-roadmap/`, active Future True UX governance and guardrail documents live under `docs/archive/future-true-ux-restore/00-governance/`, and historical Future True UX stage evidence lives under `docs/archive/future-true-ux-restore/01-*` through `06-*`. This document does not demote gates, rename gate IDs, change workflow behavior, delete files, or authorize true UX restore planning.
...
|---|---|---|
| Canonical active archive governance | `docs/archive/completed-roadmap/issue-18/64-issue18-manual-closure-handoff.md`, `docs/archive/future-true-ux-restore/00-governance/65-future-true-ux-restore-execution-split.md`, `docs/archive/future-true-ux-restore/00-governance/66-future-true-ux-restore-authorization-intake.md`, `docs/archive/future-true-ux-restore/00-governance/67-future-true-ux-restore-evidence-model.md`, `docs/archive/future-true-ux-restore/00-governance/68-future-true-ux-restore-dry-run-plan.md`, `docs/archive/future-true-ux-restore/00-governance/106-future-true-ux-restore-final-stop-line-handoff.md`, `docs/archive/future-true-ux-restore/00-governance/107-future-true-ux-restore-stop-line-decision-matrix.md`, `docs/archive/future-true-ux-restore/00-governance/108-repo-documentation-script-governance-audit.md`, `docs/archive/future-true-ux-restore/00-governance/109-future-true-ux-quality-gate-governance.md`, `docs/archive/future-true-ux-restore/00-governance/110-future-true-ux-archive-policy-reference-map.md`, `docs/archive/future-true-ux-restore/00-governance/111-future-true-ux-archive-dry-run-plan.md` | Keep referenced and locked as needed, but do not keep these English governance documents in root. Archive placement is organizational only and does not lower safety semantics. |
| Active safety guardrail | `docs/archive/future-true-ux-restore/00-governance/69-future-true-ux-restore-current-user-dry-run-gate.md` through `docs/archive/future-true-ux-restore/00-governance/79-future-true-ux-restore-authorization-state-machine.md` | Keep active until later gates and tests preserve the same no-execution and evidence-boundary checks. These guardrails live in `00-governance/`, not root. |
...
The archive map intentionally covers all current Future True UX quality gates from `docs/archive/future-true-ux-restore/00-governance/109-future-true-ux-quality-gate-governance.md`:

| Gate ID | Current archive-policy coverage |
|---|---|
| `future-true-ux-restore-split` | Canonical active archive governance; keep referenced in `00-governance/`. |
| `future-true-ux-restore-authorization` | Canonical or active safety guardrail; keep referenced docs and validators active. |
| `future-true-ux-restore-evidence-model` | Canonical active archive governance; keep referenced in `00-governance/`. |
| `future-true-ux-current-user-dry-run` | Active safety guardrail; keep referenced in `00-governance/`. |
| `future-true-ux-scope-dry-run` | Active safety guardrail; keep referenced in `00-governance/`. |
| `future-true-ux-scope-guard-matrix` | Active safety guardrail; keep referenced in `00-governance/`. |
| `future-true-ux-execute-gate` | Active safety guardrail; keep referenced in `00-governance/`. |
| `future-true-ux-authorization-review` | Active safety guardrail; keep referenced in `00-governance/`. |
| `future-true-ux-evidence-packet` | Active safety guardrail; keep referenced in `00-governance/`. |
...
| `future-true-ux-final-stop-line-handoff` | Canonical active archive governance; keep referenced in `00-governance/`. |
...
## Root Files That Must Remain Canonical

Do not move these root files without a separate governance task and atomic reference update:

- Root project entrypoints: `README.md`, `AGENTS.md`, and `docs/README.md`.
- Chinese operator docs: `docs/00-*.md` through `docs/10-*.md`.
- Workflow and template docs: `docs/codex-workflow.md`, `docs/codex-task-card-template.md`, and `docs/vm-test-runbook.md`.

English completed-roadmap and Future True UX governance documents should remain under archive paths while their Quality Gates, Build Lock, Pester, README, and script references stay accurate.
