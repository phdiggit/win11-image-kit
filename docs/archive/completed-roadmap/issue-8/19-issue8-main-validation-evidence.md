...
Evidence:
- Policy: `docs/archive/completed-roadmap/issue-8/16-issue8-defender-exclusion-policy.md`
- Acceptance matrix: `docs/archive/completed-roadmap/issue-8/17-issue8-defender-exclusion-acceptance.md`
- Close preparation: `docs/archive/completed-roadmap/issue-8/18-issue8-close-preparation.md`
- Main validation evidence: `docs/archive/completed-roadmap/issue-8/19-issue8-main-validation-evidence.md`
