...
| Documentation | `docs/archive/completed-roadmap/issue-11/28-issue11-capability-registry.md`, this note, `docs/archive/completed-roadmap/issue-11/30-issue11-close-preparation.md`, `docs/archive/completed-roadmap/issue-11/31-issue11-main-validation-evidence.md` | Describes operating rules, acceptance state, close preparation, and pending main evidence. |
